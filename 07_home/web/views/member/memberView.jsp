...
<section id="enroll-container">
		...
		<table>
			<tr>
				...
				<td><input type="text" name="userId" id="userId_"
					value="<%=member.getMemberId()%>" readonly> <!-- 이곳에 폼을 넣어봤자 위의 폼의 액션이 적용되기에 스크립트문으로 해결 -->
				</td>
			</tr>
			<tr>
				<th>비밀번호</th>
			...
			<tr>
				<th>비밀번호 확인</th>
				<td><input type="password" name="passwordcheck" id="password_2"
					value="<%=member.getMemberPw()%>" required></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="userName" id="userName"
					value="<%=member.getMemberName()%>" required></td>
			</tr>
			<tr>
				<th>나이</th>
			...
			<tr>
				...
				<td>
					...
					%> <input type="radio"
					name="gender" id="gender0" value="M" checked> <label
 ...
 %>
					...
					for="gender0">남</label> <input type="radio" name="gender"
					id="gender1" value="F" checked> <label for="gender1">여</label>
					<%
						}
					%>
				</td>
			...
			<tr>
				...
				<td><input type="checkbox" name="hobby" id="hobby0" value="운동"
					<%=checked[0]%>> <label for="hobby0">운동</label> <input
					type="checkbox" name="hobby" id="hobby1" value="등산"
					<%=checked[1]%>> <label for="hobby1">등산</label> <input
					type="checkbox" name="hobby" id="hobby2" value="독서"
					<%=checked[2]%>> <label for="hobby2">독서</label> <input
					type="checkbox" name="hobby" id="hobby3" value="게임"
					<%=checked[3]%>> <label for="hobby3">게임</label> <input
					type="checkbox" name="hobby" id="hobby4" value="여행"
					<%=checked[4]%>> <label for="hobby4">여행</label></td>
			</tr>
		</table>
