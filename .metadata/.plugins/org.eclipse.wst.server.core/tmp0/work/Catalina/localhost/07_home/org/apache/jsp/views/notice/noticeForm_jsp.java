 ...
 * Generated at: 2018-05-30 12:15:10 UTC
...
return;
 ...
 if(memberLoggedIn!=null && memberLoggedIn.getMemberId().equals("admin")){
      ...
      out.write("\ttable textarea{  resize: none;}\r\n");
      out.write("</style>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/noticeFormEnd\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      out.write("    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!--반드시 post로 보낸다.\r\n");
      out.write("    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t파일보낼떄 꼭 서야하는것이다.-->\r\n");
      ...
      out.write("            <td><input type=\"file\" name=\"up_file\"></td>\r\n");
      out.write("        </tr>\r\n");
      out.write("        <tr>\r\n");
      out.write("            <th>내 용</th>\r\n");
