 ...
 * Generated at: 2018-05-30 05:49:29 UTC
...
return;
 ...
 if(memberLoggedIn!=null && "admin".equals(memberLoggedIn.getUserId())) {
      ...
      out.write("\r\n");
      out.write("    <style>\r\n");
      out.write("    div#board-container{width:600px; margin:0 auto; text-align:center;}\r\n");
      out.write("    div#board-container h2{margin:10px 0;}\r\n");
 ...
 if(b.getBoardOriginalFileName() != null){ 
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"javascript:fn_fileDownload('");
      out.print( b.getBoardOriginalFileName() );
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(b.getBoardRenameFileName());
      out.write("');\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\tfunction fn_fileDownload(oriName, reName)\r\n");
      out.write("\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\tvar url=\"");
      out.print(request.getContextPath());
      out.write("/boardFileDownLoad\";\r\n");
      out.write("\t\t\t\t\t\t\toName=encodeURIComponent(oriName);\r\n");
      out.write("\t\t\t\t\t\t\t//인코딩처리르해야지 파일명이 제대로 넘어감.\r\n");
      out.write("\t\t\t\t\t\t\tlocation.href=url+\"?oName=\"+oName+\"&rName=\"+reName;\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t<input type=\"button\" value=\"목록으로\" onclick=\"fn_goList()\">\r\n");
      out.write("\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\tfunction fn_goList()\r\n");
      out.write("\t\t\t\t\t\t{\r\n");
 ...
 if(memberLoggedIn!=null && 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<input type=\"button\" value=\"수정하기\" onclick=\"fn_updateBoard()\">\r\n");
      out.write("\t\t\t\t\t<input type=\"button\" value=\"삭제하기\" onclick=\"fn_deleteBoard()\">\r\n");
      out.write("\t\t\t\t</th>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t");
} 
      ...
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<!--관리자만볼수있으며 hiiden으로 값을 감춰놓고 함수문만 별도로 보낸다.-->\r\n");
      out.write("\t\t\t");
 if(memberLoggedIn!=null && 
            (b.getBoardWriter().equals(memberLoggedIn.getUserId())
            || "admin".equals(memberLoggedIn.getUserId())) ){ 
      ...
      out.print(request.getContextPath());
      out.write("/boardDelete\" method=\"post\">\r\n");
      out.write("\t\t    <input type=\"hidden\" name=\"no\" value=\"");
      out.print(b.getBoardNo() );
      out.write("\" />\r\n");
      out.write("\t\t    <input type=\"hidden\" name=\"renamedFileName\" value=\"");
      out.print( b.getBoardRenameFileName()!=null?b.getBoardRenameFileName():"");
      out.write("\" />\r\n");
      out.write("\t\t    </form>\r\n");
      out.write("\t\t    ");
} 
